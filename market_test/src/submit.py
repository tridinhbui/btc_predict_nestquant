...
class Submission(Base):
    def __init__(self, api_key):
        ...
        self._cur_round = self._get('https://api-dev.nestquant.com/competition/nestquant_tournament_2023/current-round').json()['Current round']
        self._records_url = 'https://api-dev.nestquant.com/competition/nestquant_tournament_2023/records/api?api_key=' + self._api_key
        self._result_url = 'https://api-dev.nestquant.com/competition/nestquant_tournament_2023/result/api?&api_key=' + self._api_key
        self._submit_url = 'https://api-dev.nestquant.com/competition/nestquant_tournament_2023/submit/api?api_key=' + self._api_key
